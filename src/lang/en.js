export default {
  ...
  curation: {
    ...
    minReputationTip: `Only the users who's reputation more than this can share the rewards`,
  ...
  ny: {
    ...
    projectDesc: '     Project advertisement. Project advertisement.\n' +
      '          Project advertisement. Project advertisement.\n' +
      '          Project advertisement. Project advertisement.',
    yourPower: 'Your power',
    totalPower: 'Total power',
    poolRewards: 'Rewards in Pool',
    makeCard: 'Make cards',
    opened: 'opened',
    power: 'Power',
    ...
    luckyCardDes1: 'The five Lucky Cards are combined with 4 Common Cards and 1 Rare Card.',
    luckyCardDes2: 'luckyCardDes1',
    luckyCardDes3: 'How to obtain the Lucky Cards?',
    luckyCardDes4: 'Interaction',
    luckyCardDes5: 'You will get a chance to win the Five Lucky Cards by using Wormhole3 during the campaign period',
    luckyCardDes6: 'Participation',
    luckyCardDes7: `Participate in the project's tasks during the event`,
    luckyCardDes8: 'Trading/Giving',
    luckyCardDes9: 'All cards can be traded and gifted',
    luckyCardDes10: 'Recommendation',
    luckyCardDes11: 'Refer 1 new user with more than 30 reputations (Rare only)',
    luckyCardDes12: 'Mint',
    luckyCardDes13: 'Per price at 0.2 $USDT (Rare only)',
    mysteryCard1: 'Mystery box cards have 5 levels, each level represents weight 1, 2, 3, 5, 10. The ultimate reward is determined by the sum of the mystery box card levels held.',
    mysteryCard2: 'How to obtain the mystery box card?',
    mysteryCard3: 'Combination',
    mysteryCard4: 'A mystery box card combined with 4 normal Luck Cards and 1 rare Luck Card',
