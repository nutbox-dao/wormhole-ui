    ...
    <div class="container mx-auto mt-6rem text-left max-w-43rem fade-in">
      <div>
        ...
        <div class="text-1rem text-text8F leading-1.8rem mt-1.4rem">
          ...
          the recipient's account (in this case, The Rock). We are currently focused on Solana
          because of its high speed and low fees. The average wait time for a transaction is 6 seconds.
        </div>
