...
import {checkCommunityRewards, checkCurationRewards, claimRewards, getClaimParas} from "@/utils/curation";
import {
  getCommunityAuthorPendingRewards,
  getCommunityPendingRewards, setCommunityAuthorRewardClaimed,
  setCommunityRewardClaimed,
  setCurationIsFeed
} from "@/api/api";
...
import RewardCuration from "@/views/user/RewardCuration.vue";
import ChainTokenIcon from "@/components/ChainTokenIcon.vue";
export default {
  name: "RewardPromotion",
  components: {RewardCuration, ChainTokenIcon, RewardHistoryList},
  setup() {
