<template>
  <div class="grid grid-cols-1 xl:grid-cols-3 md:gap-1rem pb-2rem">
    <div class="col-span-1 xl:col-start-3 xl:col-end-4 border-1 border-dividerColor px-1rem rounded-12px md:my-2rem my-1.5rem h-min overflow-hidden mx-1.5rem md:mx-0">
